...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('two_robot_nav')
    ...
    declare_world_cmd = DeclareLaunchArgument(
        'world',
        default_value=os.path.join(bringup_dir, 'world', 'world.model'),
    ...
    declare_robot2_params_file_cmd = DeclareLaunchArgument(
        'robot2_params_file',
        default_value=os.path.join(bringup_dir, 'resource', 'nav2_multirobot_params_2.yaml'),
